...
Comprehensive guide for writing efficient and scalable React and Next.js applications, designed for AI agents and LLMs. Contains 38 rules across 7 categories, prioritized by impact from critical (eliminating waterfalls, reducing bundle size) to incremental (advanced patterns). Covers patterns for async operations, component composition, state management, rendering efficiency, and JavaScript optimization.
...
**Aligned with `petfriends-coding-guide`:** When code clarity, maintainability, or responsibility separation conflicts with performance optimization patterns, follow `petfriends-coding-guide` as the priority.
...
5. [Rendering Performance](#5-rendering-performance) — **MEDIUM**
   ...
   - 5.6 [Use Activity Component for Show/Hide](#56-use-activity-component-for-showhide)
